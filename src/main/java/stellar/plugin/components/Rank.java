...
public enum Rank {
    player(Fx.burning),
    beginner(Color.valueOf("#fc693d"), "\uE872", new Requirements(5, 10, 2, 200, 1 * 60), player, Fx.vaporSmall, Color.valueOf("#fc693d")),
    active(Color.valueOf("#ff8f40"), "\uE86B", new Requirements(8, 25, 3, 500, 2 * 60), beginner, Fx.vaporSmall, Color.valueOf("#ff8f40")),
    expert(Color.valueOf("#f2e33d"), "\uE86E", new Requirements(12, 50, 5, 1000, 4 * 60), active, Fx.vaporSmall, Color.valueOf("#f2e33d")),
    veteran(Color.valueOf("#66f556"), "\uE809", new Requirements(15, 100, 8, 2000, 8 * 60), expert, Fx.vaporSmall, Color.valueOf("#66f556")),
    elite(Color.valueOf("#8cddff"), "\uE80E", new Requirements(20, 200, 12, 5000, 16 * 60), veteran, Fx.vaporSmall, Color.valueOf("#8cddff")),
    master(Color.valueOf("#547cff"), "\uE88B", new Requirements(30, 400, 16, 10000, 24 * 60), elite, Fx.vaporSmall, Color.valueOf("#547cff")),
