...
import stellar.plugin.database.enums.PlayerEventTypes;
import stellar.plugin.database.enums.ServerEventTypes;
import stellar.plugin.database.gen.Tables;
import stellar.plugin.database.gen.tables.records.*;
